...
export interface ApiRameurRameur extends Schema.CollectionType {
...
export interface ApiResultaResulta extends Schema.CollectionType {
  collectionName: 'resultas';
  info: {
    singularName: 'resulta';
    pluralName: 'resultas';
    displayName: 'resulta';
  };
  options: {
